  ...
  private void cssInitializer() {
    css = new com.sencha.gxt.core.client.dom.Mask.MaskDefaultAppearance.MaskStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GIAX32YDHJ{z-index:" + ("100")  + ";top:" + ("0")  + ";right:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";zoom:" + ("1")  + ";position:" + ("absolute")  + ";opacity:" + ("0.5")  + ";background-color:" + ("#ccc")  + ";}.GIAX32YDGJ{z-index:" + ("101")  + ";position:") + (("absolute")  + ";top:" + ("0")  + ";right:" + ("0")  + ";border:" + ("1px"+ " " +"solid")  + ";padding:" + ("2px")  + ";height:" + ((Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getSafeUri().asString() + "\") -" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getLeft() + "px -" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getTop() + "px  repeat-x")  + ";border-color:" + ("#6593cf")  + ";background-color:" + ("#c3daf9")  + ";}.GIAX32YDKJ{padding:" + ("5px"+ " " +"10px"+ " " +"5px"+ " " +"10px") ) + (";border:" + ("1px"+ " " +"solid")  + ";cursor:" + ("wait")  + ";background-color:" + ("white")  + ";border-color:" + ("#a3bad9")  + ";color:" + ("#222")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GIAX32YDJJ{position:" + ("relative")  + " !important;}.GIAX32YDIJ{overflow:" + ("hidden")  + " !important;}.GIAX32YDIJ select,.GIAX32YDIJ object,.GIAX32YDIJ embed{visibility:" + ("hidden")  + ";}")) : ((".GIAX32YDHJ{z-index:" + ("100")  + ";top:" + ("0")  + ";left:" + ("0")  + ";width:" + ("100%")  + ";height:" + ("100%")  + ";zoom:" + ("1")  + ";position:" + ("absolute")  + ";opacity:" + ("0.5")  + ";background-color:" + ("#ccc")  + ";}.GIAX32YDGJ{z-index:" + ("101")  + ";position:") + (("absolute")  + ";top:" + ("0")  + ";left:" + ("0")  + ";border:" + ("1px"+ " " +"solid")  + ";padding:" + ("2px")  + ";height:" + ((Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getSafeUri().asString() + "\") -" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getLeft() + "px -" + (Mask_MaskDefaultAppearance_MaskResources_safari_default_InlineClientBundleGenerator.this.boxBackground()).getTop() + "px  repeat-x")  + ";border-color:" + ("#6593cf")  + ";background-color:" + ("#c3daf9")  + ";}.GIAX32YDKJ{padding:" + ("5px"+ " " +"10px"+ " " +"5px"+ " " +"10px") ) + (";border:" + ("1px"+ " " +"solid")  + ";cursor:" + ("wait")  + ";background-color:" + ("white")  + ";border-color:" + ("#a3bad9")  + ";color:" + ("#222")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"helvetica"+ ","+ " " +"sans-serif")  + ";}.GIAX32YDJJ{position:" + ("relative")  + " !important;}.GIAX32YDIJ{overflow:" + ("hidden")  + " !important;}.GIAX32YDIJ select,.GIAX32YDIJ object,.GIAX32YDIJ embed{visibility:" + ("hidden")  + ";}"));
      }
